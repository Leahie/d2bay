    ...
    return(
        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
                <li>
                    <a href="/settings/profile" className={`flex ${Number(page) == 1 ? "  bg-slate-300 text-gray-900 dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700" : ""}items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
                ...
                <li>
                    <a href="#" className={`flex ${Number(page) == 2 ? "  bg-slate-300 text-gray-900 dark:text-white hover:bg-gray-400 dark:hover:bg-gray-700" : ""}items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group`}>
